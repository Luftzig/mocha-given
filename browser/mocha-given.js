...
Waterfall = (function() {
  function Waterfall(context1, functions, finalCallback) {
    var func, j, len, ref;
    ...
    this.invokeFinalCallbackIfNecessary = bind(this.invokeFinalCallbackIfNecessary, this);
    this.asyncTaskCompleted = bind(this.asyncTaskCompleted, this);
